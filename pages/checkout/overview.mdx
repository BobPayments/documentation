...
<Note>
  O checkout hospedado aceita os métodos **habilitados no projeto**: **PIX**, **cripto** e **cartão de crédito (beta)**. Informe-os em `paymentMethods` (default `["pix"]`).
</Note>

<Note>
  Para usar cartão de crédito no checkout hospedado, converse primeiro com o time de vendas para avaliar e habilitar o acesso beta: [falar pelo WhatsApp](https://wa.me/5521992614614) ou [enviar e-mail](mailto:contato@payments.bob.company).
</Note>
