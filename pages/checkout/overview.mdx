...
- **`paymentMethods` controla as opções exibidas** — use `["pix"]`, `["credit_card"]` ou combine os métodos disponíveis no seu projeto. O padrão é `["pix"]`.
...
- **Quer manter o comprador no seu site?** Use o [SDK Checkout](/pages/sdk/checkout). Ele embute o checkout da Bob sem expor Stripe.js para a sua aplicação.
