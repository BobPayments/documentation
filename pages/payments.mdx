...
<Note>
  A integração com cartão de crédito está em **beta**. Um método só pode ser usado quando estiver **habilitado no projeto**. O enum da API lista os métodos do contrato; a criação falha se o método não estiver publicado na sua conta.
</Note>
