...
<Note>
  A integração com cartão de crédito está em **beta**. Fale com o time de vendas pelo [WhatsApp](https://wa.me/5521992614614) ou [e-mail](mailto:contato@payments.bob.company) para avaliar e habilitar o seu projeto. Um método só pode ser usado quando estiver **habilitado no projeto**.
</Note>
