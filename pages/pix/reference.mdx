...
<ResponseField name="paymentMethod" type="string">
  Método de pagamento da transação. Na criação direta documentada, use `pix` ou omita o campo para aplicar o default.
</ResponseField>
...
<CardGroup cols={2}>
  ...
  <Card title="Checar status" icon="magnifying-glass" href="/pages/pix/check-status">
