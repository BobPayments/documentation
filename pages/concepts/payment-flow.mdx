...
<Note>
  **PIX** está disponível. Cripto e cartão de crédito estão em **beta** e dependem da habilitação no projeto. A API direta também aceita o `paymentMethod` correspondente quando publicado para a sua conta.
</Note>
