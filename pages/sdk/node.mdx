---
title: "SDK Node.js"
description: "Biblioteca oficial TypeScript/Node.js — tipos completos, idempotência automática e webhooks verificados."
icon: "node-js"
---
...
Todo `create` envia um header [`Idempotency-Key`](/pages/idempotency) automaticamente, o que torna a chamada segura de repetir — o SDK faz retry com backoff em timeout, falha de rede, 429 e 5xx sem risco de PIX duplicado.
