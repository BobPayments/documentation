...
<Note>
  Credit card integration is in **beta**. A method can only be used when it's **enabled on the project**. The API enum lists contract methods; creation fails if the method is not published for your account.
</Note>
