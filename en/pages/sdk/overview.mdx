...
<Note>
  Server SDKs cover PIX, card, and crypto. Card and crypto are in **beta** and require a sales review: [WhatsApp](https://wa.me/5521992614614) or [email](mailto:contato@payments.bob.company). The [Checkout SDK](/en/pages/sdk/checkout) embeds the UI in the browser. Use only methods **enabled on the project**.
</Note>
