...
<Note>
  Server SDKs cover PIX, card (`btk_...` + tokenization), and crypto. The [Checkout SDK](/en/pages/sdk/checkout) embeds the UI in the browser. Use only methods **enabled on the project**.
</Note>
